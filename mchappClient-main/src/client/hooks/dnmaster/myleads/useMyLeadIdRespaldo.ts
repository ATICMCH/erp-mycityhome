...
const useMyLeadIdR = () => {
    ...
    return {
        ...
        handleChange,
        handleSave,
        handleCancel: () => handleCancel('/dnmaster/myleads', router),
        handleAddTelefono,
