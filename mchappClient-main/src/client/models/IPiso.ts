export interface IPiso {
      ...
      //Parametro adicional para saber si esta seleccionado
      propID?:String
      ...
      variablesreserva?: Array<{id: number, total: number, precio_muebles: number, precio_alquiler: number}>
