...
import ControlLimpiezaList from './ControlLimpiezaList'
// import Pagination from "";

const ControlLimpiezaContainer = () => {
    const { 
            pageCurrent,
            listData, 
            filterFields, 
            ...
            <div className="w-[80rem] h-auto bg-[#badaed] border border-blue rounded-t-3xl grid table-filter">
                <div className="w-full pt-4 pl-2 pr-1 flex">
                    <div className="w-full flex">
                        <h1 className="w-full text-bold text-blue" style={{fontSize:'22px'}}>{ `Limpieza` }</h1>
                    </div>
            ...
            <div>
                <div className={`w-full h-auto table-header`}>
                    <div className="grid grid-cols-7 p-2 pl-2 text-bold text-white bg-[#0077BD]">
                        ...
                        <div className=""><span className='flex'>Persona</span></div>
                        <div className=""><span className='grid justify-end'>Fecha</span></div>
                        <div className=""><span className='grid justify-end'>Entrada</span></div>
                        <div className=""><span className='grid justify-end'>Salida</span></div>
                        <div className=""><span className='grid justify-end'>Horas</span></div>
                    ...
                    loading ? 
                                ...
                                ( 
                                    listData.length === 0 ? 
                                        ...
                                        : 
                                        <>
                                            <ControlLimpiezaList items={listData} /> 
                                        </>
...
export default ControlLimpiezaContainer