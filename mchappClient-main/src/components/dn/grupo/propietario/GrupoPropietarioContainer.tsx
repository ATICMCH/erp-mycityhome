...
import useGrupoPropietario from '@/client/hooks/dn/grupo/propietario/useGrupoPropietario'
import GrupoPropietarioList from './GrupoPropietarioList'

const GrupoPropietarioContainer = () => {
    const { 
            pageCurrent,
            listData, 
            filterFields, 
        ...
        <div className="w-[80rem] h-auto grid1 grid-flow-row1">
            ...
            <div className="w-[80rem] h-auto bg-[#badaed] border border-blue rounded-t-3xl grid table-filter">
                <div className="w-full pt-4 pl-2 pr-1 flex">
                    <div className="w-full flex">
                        <h1 className="w-full text-bold text-blue" style={{fontSize:'22px'}}>{ `Propietarios` }</h1>
                    </div>
            ...
            <div>
                <div className={`w-full h-auto table-header`}>
                    <div className="grid grid-cols-5 p-2 pl-2 text-bold text-white bg-[#0077BD]">
                        ...
                        <div className=""><span className='grid justify-end'># Llamadas</span></div>
                    </div>
                </div>
                {
                    loading ? 
                                ...
                                ( 
                                    listData.length === 0 ? 
                                        ...
                                        : 
                                        <>
                                            <GrupoPropietarioList items={listData} />
                                        </>
...
export default GrupoPropietarioContainer