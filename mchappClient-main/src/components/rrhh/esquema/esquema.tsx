...
import useEsquema from '@/client/hooks/rrhhmaster/esquema/useEsquema'
import { BsCalendar3 } from 'react-icons/bs'
//import useUser from '@/client/hooks/share/users/useUser'

const UsersEsquemaContainer = (
    ...
    const { 
            ...
            handlerOnPage,
            handleActionSearch 
    } = useEsquema(typeTotalData, pathGetData)
            ...
            <div className="w-[80rem] h-auto bg-[#badaed] border border-blue rounded-t-3xl grid table-filter">
                <div className="w-full pt-4 pl-2 pr-1 flex">
                    <div className="w-full flex">
                        <h1 className="w-full text-bold text-blue" style={{fontSize:'22px'}}>{ `Esquema` }</h1>
                    </div>
                ...
                <div className={`w-full h-auto table-header`}>
                    <div className="grid grid-cols-8 p-2 pl-2 text-bold text-white bg-[#0077BD]">
                        ...
                        <div className="grid col-span-2"><span className='grid'>Horario</span></div>
                        <div className="grid col-span-2"><span className='grid'>Horas</span></div>
...
export default UsersEsquemaContainer