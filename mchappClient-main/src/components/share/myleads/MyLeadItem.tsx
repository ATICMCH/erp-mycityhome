...
const MyLeadItem = ({ item, pathEdit } : 
                            {
                                item: ILead,
                                pathEdit: string
                            }) => {
    ...
    return (
        <div className={`w-full h-auto`}>
            ...
            <div
                ...
                className={`data-table-row grid grid-cols-5 p-1 pl-2 ${itemContent.lbl_orden === 'orden_2'?'txt-orange-f3bb6d':'text-[#0077BD]'}`}>
