...
const CalendarioAtic = () => {
    // Componente de calendario para ATIC - Deploy test
            ...
            <div className="h-100 bg-image p-5 pt-2 flex">
                ...
                <ContentContainer>
                    <div className="w-full">
                        <h1 className="text-2xl font-bold mb-4 text-white">Calendario ATIC</h1>
                        ...
                        <div className="bg-white rounded-lg p-4 shadow-lg">
                            ...
                            <iframe 
                                ...
                                frameBorder="0" 
                                scrolling="no"
                                title={`Calendario ATIC - ${calendarios[calendarioActivo as keyof typeof calendarios].title}`}
                            />
                        </div>
                    </div>
                </ContentContainer>
