...
const ApartmentsById = () => {
    ...
    // const [MenuPiso, setMenuPiso] = useState<string>('infoPiso')
    // const handlerClickTab = (e: any) => {
    //     //alert(`${e.target.name} => ${e.target.value}`)
    //     setMenuPiso(e.target.name)  
    //}
    return (
        <Layout>
            <div className="w-auto min-h-[31rem] grid lg:grid-cols-[1fr,auto] px-3">
                <div className="w-full min-h-[30rem] md:pl-[2rem]">
                    <div className="bg-[#ffffff72] h-full w-full rounded-2xl shadow-2xl p-2 sm:p-5">
                        <div className="min-h-[25rem] grid grid-cols-1 space-y-3">
                            <div className="h-full grid space-y-2 md:ml-5">
                                <div className=" w-full flex text-sm mb-4">
                                    {/* <button type='submit' name="infoPiso" id='infoPiso' onClick={handlerClickTab} className='px-3 py-2 h-auto w-[10rem] bg-[#0077bd] text-white rounded-full'>INFO</button> */}
                                    {/* <button type='submit' name="mantePiso" id='mantePiso' onClick={handlerClickTab} className='px-3 py-2 h-auto w-[10rem] bg-[#0077bd] text-white rounded-full ml-4'>MANTENIMIENTO</button>    */}
        ...
        <div className="min-h-[25rem] bg-[#5da7d5c0] rounded-2xl p-2 sm:p-4 space-y-3">
                ...
                <fieldset className="grid border border-solid border-gray-300 p-2 sm:p-4 space-y-3 mb-4 rounded-lg">
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-3'>
                        <div className=" w-full flex text-sm">
                            ...
                            <input placeholder='Ubicación mapa' type="text" onChange={handleChange} name='ubicacion_mapa' value={dataDB.ubicacion_mapa} className="rounded-r-full p-2 w-[100%]" />
                        </div>
                        <div className=" w-full flex text-sm">
                            <label className='px-3 py-2 h-auto w-[2.5rem] bg-[#0077bd] text-white rounded-l-full'>
                                <BiShow title='Vistas' size={'1.2rem'} />
                            </label>
                            <select onChange={handleChange} name='if_vista' value={dataDB.if_vista} className="rounded-r-full p-1 w-[100%]">
                        ...
                        <div className=" w-full flex text-sm">
                            ...
                            <select onChange={handleChange} name='if_clase' value={dataDB.if_clase} className="rounded-r-full p-1 w-[100%]">
            ...
            <div>
                ...
                <div className='grid grid-cols-1 md:grid-flow-col md:grid-cols-5 gap-3'>
                        <div className="w-full flex text-sm">
                            <label className='px-3 py-2 h-auto w-[2.5rem] bg-[#0077bd] text-white rounded-l-full'>
                    ...
                    <div className='grid grid-cols-1 md:grid-flow-col md:grid-cols-5 gap-3'>
                        ...
                        <div className=" w-full flex text-sm">
                            ...
                            <select value={dataDB.ca_discapacidad !== undefined ? (dataDB.ca_discapacidad?'true':'false'):'-2'} onChange={handleChange} name='ca_discapacidad' className="rounded-r-full p-1 w-[75%]">
                                { useMemo(() => drawListOnSelect(STATES_BOOLEAN, 's-ca_discapacidad', 'Accesibilidad?'), []) }
                            </select>
                        </div>
                    </div>
                    <div className='grid grid-cols-1 md:grid-flow-col md:grid-cols-4 gap-3'>
                        <div className=" w-full flex text-sm">
                            <label className='px-3 py-2 h-auto w-[2.5rem] bg-[#0077bd] text-red rounded-l-full'>
                                <TbListNumbers title="Nro Estancias" color={'white'} className='w-[1.2rem] h-[1.2rem]' />
                            </label>
                            <input placeholder='Nro de Estancias' type="number" onChange={handleChange} name='cp_estancia_total' value={dataDB.cp_estancia_total !== undefined ? dataDB.cp_estancia_total : ''} className="rounded-r-full p-2 w-[80%]" />
                        </div>
                        <div className=" w-full flex text-sm">
                            <label className='px-3 py-2 h-auto w-[2.5rem] bg-[#0077bd] text-red rounded-l-full'>
                                <FaKey title="Puertas con cerradura" color={'white'} className='w-[1.2rem] h-[1.2rem]' />
                            </label>
                            <select value={dataDB.cp_cerradura_puertas !== undefined ? (dataDB.cp_cerradura_puertas?'true':'false'):'-2'} onChange={handleChange} name='cp_cerradura_puertas' className="rounded-r-full p-1 w-[80%]">
                                { useMemo(() => drawListOnSelect(STATES_BOOLEAN, 's-cp_cerradura_puertas', 'Puertas con cerraduras?'), []) }{/*Revisar funcionamiento*/} 
                            </select>
                        </div>
                        <div className=" w-full flex text-sm">
                            <label className='px-3 py-2 h-auto w-[2.5rem] bg-[#0077bd] text-red rounded-l-full'>
                                <BiMoveVertical title="Nro Plantas" color={'white'} className='w-[1.2rem] h-[1.2rem]' />
                            </label>
                            <input placeholder='Nro de Plantas' type="number" onChange={handleChange} name='cp_nro_plantas' value={dataDB.cp_nro_plantas !== undefined ? dataDB.cp_nro_plantas : ''} className="rounded-r-full p-2 w-[80%]" />
                        </div>
                        <div className=" w-full flex text-sm">
                                <label className='px-3 py-2 h-auto w-[2.5rem] bg-[#0077bd] text-red rounded-l-full'>
                                    <FaHandsWash title="Nro Aseos" color={'white'} size={'1.2rem'} />
                                </label>
                                <input placeholder='Nro aseos' type="number" onChange={handleChange} name='bs_nro_aseos' value={dataDB.bs_nro_aseos !== undefined ? dataDB.bs_nro_aseos : ''} className="rounded-r-full p-2 w-[80%]" />
                            </div>  
                    </div>
            ...
            <div>
                <fieldset className="grid border border-solid border-gray-300 p-3 space-y-3 mb-4 rounded-lg">
                    ...
                    <div className='grid grid-cols-1 md:grid-flow-col md:grid-cols-5 gap-3'>
                        ...
                        <div className=" w-full flex text-sm">
                        <label className='px-3 py-2 h-auto w-[2.5rem] bg-[#0077bd] text-red rounded-l-full'>
                            <GiFrenchFries title="Freidora" color={'white'} className='w-[1.2rem] h-[1.2rem]' />
                        </label>
                        <select value={dataDB.co_freidora !== undefined ? (dataDB.co_freidora?'true':'false'):'-2'} onChange={handleChange} name='co_freidora' className="rounded-r-full p-1 w-[75%]">
                            { useMemo(() => drawListOnSelect(STATES_BOOLEAN, 's-co_freidora', 'Tiene freidora?'), []) }{/*Revisar funcionamiento*/} 
                        </select>
                        </div>
                        <div className=" w-full flex text-sm">
                            <label className='px-3 py-2 h-auto w-[2.5rem] bg-[#0077bd] text-red rounded-l-full'>
                                <GiKitchenScale title="Horno" color={'white'} className='w-[1.2rem] h-[1.2rem]' />
                            </label>
                            <select value={dataDB.co_horno !== undefined ? (dataDB.co_horno?'true':'false'):'-2'} onChange={handleChange} name='co_horno' className="rounded-r-full p-1 w-[75%]">
                                { useMemo(() => drawListOnSelect(STATES_BOOLEAN, 's-co_horno', 'Tiene Horno?'), []) }{/*Revisar funcionamiento*/} 
                            </select>
                        </div>
                    </div>
                </fieldset>
                ...
                <fieldset className="grid border border-solid border-gray-300 p-3 space-y-3 mb-4 rounded-lg">
                    ...
                    <div className='grid grid-cols-1 md:grid-flow-col md:grid-cols-5 gap-3'>
                        ...
                        <div className=" w-full flex text-sm">
                            ...
                            <select value={dataDB.ah_minibar !== undefined ? (dataDB.ah_minibar?'true':'false'):'-2'} onChange={handleChange} name='ah_minibar' className="rounded-r-full p-1 w-[75%]">
                        ...
                        <div className=" w-full flex text-sm">
                            ...
                            <select value={dataDB.ah_ventilador_techo !== undefined ? (dataDB.ah_ventilador_techo?'true':'false'):'-2'} onChange={handleChange} name='ah_ventilador_techo' className="rounded-r-full p-1 w-[75%]">
                                { useMemo(() => drawListOnSelect(STATES_BOOLEAN, 's-ah_ventilador_techo', 'Ventilador Techo?'), []) }{/*Revisar funcionamiento*/} 
                            </select>
                        </div>
                    </div>
                    <div className='grid grid-cols-1 md:grid-flow-col md:grid-cols-3 gap-3'>
                        <div className=" w-full flex text-sm">
                            <label className='px-3 py-2 h-auto w-[2.5rem] bg-[#0077bd] text-red rounded-l-full'>
                                <GiWashingMachine title="Lavadora" color={'white'} className='w-[1.2rem] h-[1.2rem]' />
                            </label>
                            <select name='ah_lavadora' value={dataDB.ah_lavadora} onChange={handleChange} className="rounded-r-full p-1 w-[85%]">
                                <option value='na'>Tipo Lavadora?</option>
                                <option value='lavadora'>Lavadora</option>
                                <option value='lavaseca'>Lavadora y Secadora</option>
                                <option value='otro'>otro</option>
                            </select>
                        </div>
                        <div className=" w-full flex text-sm">
                            <label className='px-3 py-2 h-auto w-[2.5rem] bg-[#0077bd] text-red rounded-l-full'>
                                <BiTv title="Tipo de TV" color={'white'} className='w-[1.2rem] h-[1.2rem]' />
                            </label>
                            <select name='ah_tipo_tv' value={dataDB.ah_tipo_tv} onChange={handleChange} className="rounded-r-full p-1 w-[85%]">
                                <option value='na'>Tipo TV?</option>
                        ...
                        <div className=" w-full flex text-sm">
                            <label className='px-3 py-2 h-auto w-[2.5rem] bg-[#0077bd] text-red rounded-l-full'>
                                <BiWifi title="Tipo de Internet" color={'white'} className='w-[1.2rem] h-[1.2rem]' />
                            </label>
                            <select name='ah_tipo_internet' value={dataDB.ah_tipo_internet} onChange={handleChange} className="rounded-r-full p-1 w-[85%]">
                                <option value='na'>Conexión Internet?</option>
                ...
                <fieldset className="grid border border-solid border-gray-300 p-3 space-y-3 mb-4 rounded-lg">
                    ...
                    <div className='grid grid-cols-1 md:grid-flow-col md:grid-cols-5 gap-3'>
                        ...
                        <div className=" w-full flex text-sm">
                            ...
                            <select value={dataDB.ca_alarma_incendios !== undefined ? (dataDB.ca_alarma_incendios?'true':'false'):'-2'} onChange={handleChange} name='ca_alarma_incendios' className="rounded-r-full p-1 w-[75%]">
                        ...
                        <div className=" w-full flex text-sm">
                            ...
                            <select name='ca_ubicacion_calefaccion' value={dataDB.ca_ubicacion_calefaccion} onChange={handleChange} className="rounded-r-full p-1 w-[75%]">
            ...
            <div>
                ...
                <legend className="ml-1 mr-1 text-[#0077bd] font-bold text-ms">Características de la Urbanización o Edificio</legend>
                    ...
                    <div className=" w-full flex text-sm">
                        ...
                        <div className=" w-full flex text-sm">
                            <label className='px-3 py-2 h-auto w-[2.5rem] bg-[#0077bd] text-red rounded-l-full'>
                                <GiBarbecue title="Zona BBQ" color={'white'} className='w-[1.2rem] h-[1.2rem]' />
                            </label>
                            <select value={dataDB.cu_zona_bbq !== undefined ? (dataDB.cu_zona_bbq?'true':'false'):'-2'} onChange={handleChange} name='cu_zona_bbq' className="rounded-r-full p-1 w-[80%]">
                                { useMemo(() => drawListOnSelect(STATES_BOOLEAN, 's-cu_zona_bbq', 'Tiene Zona BBQ?'), []) }{/*Revisar funcionamiento*/} 
                            </select>
                        </div>   
                    </div>
                </fieldset>
