...
import useApartmentId from '@/client/hooks/dn/apartments/useApartmentId'
...
const ApartmentsById = () => {
    ...
    return (
        <Layout>
            <div className="w-full h-full md:w-2/2 lg:w-2/2 xl:w-3/3 grid items-center justify-items-center">
                <div className="h-full rounded-3xl bg-[#0077bdaf] py-10 px-10 space-y-5">
                    { errorValidate ?
