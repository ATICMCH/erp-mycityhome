...
import useMyLeadId from '@/client/hooks/dn/myleads/useMyLeadId'
                                ...
                                <div className='grid grid-cols-2 space-x-2'>
                                    ...
                                    <div className="w-full flex text-xs">
                                        ...
                                        <select value={dataDB.idtipointeresa} onChange={handleChange} name='idtipointeresa' className="rounded-r-full p-2 w-[100%] col-span-6">
                                            {useMemo(() => {
                                                const modifiedList = listInteresa.filter(item => item.name !== null && item.name !== ''); 
                                                // Filtra para que no aparezcan opciones con name vacío
                                                return drawListOnSelect(modifiedList, 'lint', 'Seleccionar Interesa');
                                            }, [listInteresa])}
                                        </select>
                                    </div>
                                <div className='grid grid-cols-2 space-x-2'>
