...
import { AiOutlinePlus, AiOutlineMinus, AiFillSave } from 'react-icons/ai'
import useMyLeadId from '@/client/hooks/dnmaster/myleads/useMyLeadIdRespaldo'
...
const FloatButton = ({ handler, Icon }: floatButtonType) => (
        ...
        <Layout>
            <div className="w-auto h-full grid grid-flow-col">
                                ...
                                <div className=" w-full flex text-xs">
                                    ...
                                    <div className='grid space-x-2'>
                                        <div className=" w-full flex text-xs">
                                            ...
                                            <input value={dataDB.nombre_completo} onChange={handleChange} type="text" name='nombre_completo' className="rounded-r-full p-2 w-[100%] outline-blue-800" />
                                        </div>
                                    </div>
                                ...
                                <select value={dataDB.estatus} onChange={handleChange} name='estatus' className="rounded-r-full p-2 w-[100%] col-span-6">
                                    ...
                                    <div className='grid grid-cols-2 space-x-2'>
                                        <div className="w-full flex text-xs">
                                            ...
                                            <input ref={refTelefono} value={dataDB.telefono} onChange={handleChange} type='text' name='telefono' className="p-2 w-[100%] rounded-r-full outline-blue-800" />
                                        ...
                                        <div className="w-full flex text-xs">
                                            ...
                                            <input ref={refCorreo} value={dataDB.correo} onChange={handleChange} type='text' name='correo' className="p-2 w-[100%] rounded-r-full outline-blue-800" />
                                            {/* <div className="w-[100%] flex">
                ...
                <ButtonContainerVertical>
                    <FloatButton handler={handleSave} Icon={AiFillSave} />
                    <FloatButton handler={handleContratar} Icon={FaHandshake} />
                    <FloatButton handler={handleDelete} Icon={FaTrashAlt} />
                    <FloatButton handler={handleCancel} Icon={MdCancel} />
                </ButtonContainerVertical>
            </div>
        </Layout>
    )
