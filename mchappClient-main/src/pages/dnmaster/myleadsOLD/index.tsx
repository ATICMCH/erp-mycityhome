...
const MyLead = () => {
    ...
    const _itemSelected = 'dn_master_myleads'
    const { listData,
        headerTable,
        loading,
        filterFields,
    ...
    const drawfilters = () => {
        return (
            <>
                <div className='w-full grid space-x-2 justify-end'>
                    <form onSubmit={handleSearch} className="w-[100%] grid grid-cols-2 text-xs px-5 justify-end">
                        ...
                        <div className="w-[100%] flex text-xs mr-0">
                            ...
                            <button className='ml-4 bg-[#0077bd] h-min text-white p-2 text-[1rem] border border-blue rounded-xl' type='submit'>Buscar</button>
