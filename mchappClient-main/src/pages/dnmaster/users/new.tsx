...
import { ALERT_DANGER, STATES } from '@/client/helpers/constants'
import AlertContainer from '@/components/AlertContainer'
import OptionsOnSelect from '@/components/OptionsOnSelect'
import ButtonContainer from '@/components/ButtonContainer'
import useUserId from '@/client/hooks/dnmaster/users/useUserId'
        ...
        <Layout>
            <div className="w-full h-full grid items-center justify-items-center">
                <div className="w-[45rem] h-full rounded-3xl bg-[#0077bdaf] py-10 px-10 space-y-5">
                    ...
                    <div>
                        <div className=" w-full grid grid-cols-8 text-lg">
                            <label className='p-4 h-min bg-[#0077bd] text-white rounded-l-full col-span-2'>Contraseña <span style={{color: 'red', fontSize: 'bold'}}>*</span></label>
                            <input type="password" onChange={handleChange} name='password' value={dataDB.password} className="rounded-r-full p-4 col-span-6" />
                        </div>
                    </div>
                    ...
                    {/* <div>
                        <div className=" w-full grid grid-cols-8 text-lg">
                            ...
                            <input type="text" readOnly onChange={handleChange} name='idrol' value={dataDB.idrol || 'Propietario'} className="rounded-r-full p-4 col-span-6" />
                        </div>
                    </div> */}
                    ...
                    <div>
                        <div className=" w-full grid grid-cols-8 text-lg">
                            <label className='p-4 h-min bg-[#0077bd] text-white rounded-l-full col-span-2'>Rol <span style={{color: 'red', fontSize: 'bold'}}>*</span></label>
                            <select value={dataDB.idrol} onChange={handleChange} name='idrol' className="rounded-r-full p-4 col-span-6">
