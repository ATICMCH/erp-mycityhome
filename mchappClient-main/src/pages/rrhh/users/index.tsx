...
import useUser from "@/client/hooks/rrhh/users/useUser"
...
const Users = () => {
    ...
    const _itemSelected = 'rrhh_users'
    ...
    const drawActions = () => {
        return (
            <>
                <Link className="p-2 h-min rounded-xl bg-[#0077bd] hover:bg-[#0077bd] text-white" href='/rrhh/users/new'>Nuevo</Link>
            </>
        )
    }
