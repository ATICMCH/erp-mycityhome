...
// import useGrupoPre from "@/client/hooks/dnmaster/grupo/prescriptor/useGrupoPre"
import TableContainerPrescriptor from "@/components/TableContainerPrescriptor"
import useGrupoPre from "@/client/hooks/rrhhmaster/grupo/prescriptor/useGrupoPre"

const GrupoPrescriptor = () => {

    const _itemSelected = 'rrhh_master_sucess_prescriptor'
    const {     listData, 
                headerTable, 
                loading, 
                filterFields,
    ...
    return (
        <Layout>
            <div className="h-100 bg-image p-5 pt-2 flex ">
                ...
                <ContentContainer>
                    <div>
                        <TableContainerPrescriptor actionOnRow={goEditData} nro_cols={7} drawactions={drawActions} drawfilters={drawfilters} title="Prescriptores"  header={headerTable} data={listData} loading={loading} />
                    </div>
                </ContentContainer>
            </div>
        </Layout>
