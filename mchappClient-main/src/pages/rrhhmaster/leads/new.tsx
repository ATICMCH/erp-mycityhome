...
const LeadNew = () => {
    const _pathGoToBack = '/rrhhmaster/leads'
    ...
    const { dataDB, 
            ...
            flagAvance,
            loadingScreen,
            setFlagAvance } = useLeadId(_pathGoToBack)
    ...
    <Layout>
        ...
        <div className="w-auto h-full grid grid-flow-col">
                                            ...
                                            dataDB.telefonos.map((el, index) => (
                                                <div className=" w-[90%] flex text-xs" key={`tlf-${index}`}>
                                                    ...
                                                    <div className="rounded-r-full p-2 px-3 w-[100%] h-[100%] bg-white flex justify-between">
                                                        <p>{el.numero}</p>
                                                        <div onClick={() => handleDeleteTelefono(el.numero)} className="h-full bg-white flex items-center">
            ...
            <ButtonContainerVertical>
                ...
                {
                    ['Propietario', 'Colaborador'].includes(dataDB.tipo_lead) ? <FloatButton title='Contratar' handler={handleContratarModal} Icon={FaHandshake} />:''
                }
