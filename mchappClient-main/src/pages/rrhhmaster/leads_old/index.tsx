            ...
            <>
                <div className='grid grid-cols-1 space-x-2 justify-end'>
                    <div className="w-[100%] flex text-xs">
                        ...
                        <div className="w-[45%] flex text-xs mr-1">
                        ...
                        <div className="w-[50%] flex text-xs mr-2">
                            <label className='p-2 h-min w-[6rem] bg-[#0077bd] text-white rounded-l-full col-span-2'>Responsable</label>
    ...
    return (
        <Layout>
            <div className="h-100 bg-image p-5 pt-2 flex ">
                ...
                <ContentContainer>
                    <div>
                        <TableContainer nro_cols={7} drawactions={drawActions} drawfilters={drawfilters} title="Leads Propietarios & Colaboradores"  header={headerTable} data={listData} loading={loading} />
                    </div>
                </ContentContainer>
            </div>
        </Layout>
