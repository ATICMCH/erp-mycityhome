...
const UserById = () => {
    const _pathGoToBack = '/rrhhmaster/vacaciones'
    const { dataDB, 
            handleChange, 
            handleSave,
            handleCancel, 
            ...
            msgError,
            roles,
             } = useVacacionesIdd(_pathGoToBack)
                                ...
                                <div className=" min-h-[16rem] bg-[#5da7d5c0] rounded-2xl p-6 space-y-3">
                                    ...
                                    <div className='grid grid-cols-2 space-x-3'>
                                        ...
                                        <div className=" w-full flex text-sm ">
                                            <label className='px-3 py-2 h-auto w-[2.5rem] bg-[#0077bd] text-white rounded-l-full col-span-2'>
                                                <span className='display-icon-error'>
                                                    <span>Sol</span> <span style={{color: 'red'}} className='field-required'> * </span>
                                                </span>
                                            </label>
                                            <input  placeholder='Fecha de Solicitud' 
                                                    disabled
                                                        type="date" 
                                                        onChange={handleChange}
                                                        name='fecha_creacion' 
                                                        value={dataDB.fecha_creacion} 
                                                        className="rounded-r-full px-1  w-[100%] border border-l-0 border-[#0077bd] col-span-6" />
                                        </div>
