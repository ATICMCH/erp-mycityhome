...
import { ALERT_DANGER, STATES_ADMIN } from '@/client/helpers/constants'
...
import useUserIdSAdmin from '@/client/hooks/share/users/useUserIdSAdmin'
...
const UserNew = () => {
    ...
    const { dataDB, 
            ...
            errorValidate, 
            msgError,
            roles } = useUserIdSAdmin(_pathGoToBack)
                                    ...
                                    <div className='grid grid-cols-2 space-x-3'>
                                        <div className=" w-full flex text-sm">
                                            ...
                                            <select value={dataDB.estado?.toString() || ''} onChange={handleChange} name='estado' className="rounded-r-full p-1 w-[100%] col-span-6">
                                                { useMemo(() => drawListOnSelect(STATES_ADMIN, 'sp', 'Seleccionar estado'), []) }
                                            </select>
                                        </div>
